    ...
    <div className="max-w-7xl mx-auto flex flex-col-reverse md:flex-row items-center justify-between px-6">
      ...
      <div className="relative md:w-1/2 flex justify-center mt-8 md:mt-0">
        ...
        <img
          src={logo1}
          alt="Logo 1"
          className="absolute lg:top-[150px] top-[80px] lg:left-5 left-1 lg:w-20 lg:h-20 w-12 h-12 bg-white p-2 rounded-full shadow-md"
        />
        <img
          src={logo2}
          alt="Logo 2"
          className="absolute top-[150px] lg:top-[250px] lg:left-[150px] left-[60px] lg:w-24 lg:h-24 w-16 h-16 bg-white p-2 rounded-full shadow-md"
        />
        <img
          src={logo3}
          alt="Logo 3"
          className="absolute lg:top-16 lg:right-1 top-10 right-0 lg:w-28 lg:h-28 w-20 h-20 bg-white p-2 rounded-full shadow-md"
        />
      </div>
    </div>
  </div>

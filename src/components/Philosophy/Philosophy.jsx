    ...
    <div className="bg-white">
      <div className="py-12 lg:px-8 px-2 text-center max-w-7xl mx-auto">
        ...
        <div className="lg:mt-12 mt-6 flex flex-col md:flex-row items-center justify-center">
          <div className="lg:w-250px bg-gradient-to-b from-[#E6F4FF] via-[#EAF7FF] to-[#F6FBFF] lg:py-[125px] py-4 rounded-xl px-10">
          ...
          <div className="lg:w-3/4 relative py-12 rounded-xl flex flex-col lg:flex-row justify-between items-center bg-[#F0F9FF]">
            <div className="hidden  md:flex flex-col items-center">
              ...
              <div className="absolute lg:top-[160px] left-[50px] lg:w-[200px]">
                <div className="bg-white shadow-xl rounded-xl py-6">
                  <h5 className="text-[#F59D71] font-bold text-[12px]">
                    MECHANISM
                  </h5>
            ...
            <div className="hidden md:flex flex-col gap-6 pr-9">
              <div className="flex items-center gap-6">
                <div className="bg-gradient-to-l from-[#EAF7FF] via-[#F8FCFF] to-[#FFFFFF] shadow-xl rounded-xl lg:w-[200px] p-6 text-center">
                  <h5 className="text-transparent bg-gradient-to-r from-[#72EAEC] to-[#3AA8A7] bg-clip-text font-semibold text-[12px]">
                    INFRASTRUCTURE
                  </h5>
              ...
              <div className="flex items-center gap-6">
                <div className="bg-white shadow-xl rounded-xl p-6 lg:w-[200px] text-center">
                  <h5 className="text-[#EFB921] font-semibold text-[12px]">
                    RESOURCE
                  </h5>
        ...
        <div className="lg:mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">

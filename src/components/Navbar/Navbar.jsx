        ...
        <div className="navbar px-4 py-2 pr-8">
          <div className="navbar-start">
            <div className="dropdown">
              ...
              <ul
                tabIndex={0}
                className="menu menu-sm dropdown-content bg-[#1154C1] text-white rounded-box z-10 mt-3 w-52 p-2 shadow flex flex-col gap-2"
              >
                <li className="dropdown dropdown-hover">
                  <p tabIndex={0} className="text-[14px]" role="button">
                    Solutions
                  </p>
          ...
          <div className="navbar-center hidden lg:flex">
            <ul className="menu menu-horizontal px-1 flex gap-4 space-x-3 items-center">
              ...
              <li className="text-white text-lg border border-transparent hover:border-b-white">Services</li>
              <li className="text-white text-lg border border-transparent hover:border-b-white">About Us</li>
              <li className="dropdown dropdown-hover border border-white rounded-3xl">
                <p
                  className="text-white text-lg"
                  tabIndex={0}
          ...
          <div className="navbar-end">
            <button className="border hidden md:flex justify-center items-center gap-3 border-white hover:bg-white hover:text-blue-500 rounded-sm py-3 px-8 font-bold group">
              Contact Us
          ...
          <div className="navbar pr-8">
            <div className="navbar-start">
              <div className="dropdown">
                ...
                >
                  ...
                  <li className="hover:border-b-blue-600">Services</li>
                  <li className="hover:border-b-blue-600">About Us</li>
                </ul>
              </div>
              <button>
            ...
            <div className="navbar-center hidden lg:flex">
              <ul className="menu menu-horizontal space-x-4 px-1 flex gap-4 items-center">
                ...
                <li className="text-[#1F80F0] text-lg border border-transparent hover:border-b-blue-600">
                  Services
                </li>
                <li className="text-[#1F80F0] text-lg border border-transparent hover:border-b-blue-600">
                  About Us
            ...
            <div className="navbar-end">
              <button className="border flex hover:shadow-xl justify-center items-center gap-3 bg-[#FE8B53] text-white rounded-sm py-3 px-7 font-bold group">
                Contact Us
                <FaAngleRight className="group-hover:translate-x-1 pt-1 transition-transform duration-300 ease-in-out" />
              </button>
            </div>
